...
@interface BizLoginViewController ()
...
@implementation BizLoginViewController
...
- (void)registerAction{
    BizRegisterViewController *bizRegisterViewController=[[BizRegisterViewController alloc]init];
    [self.navigationController pushViewController:bizRegisterViewController animated:YES];
